...
class RaftRpcUtil : public std::enable_shared_from_this<RaftRpcUtil>
{
  ...
  public:
	/**  Async method */
	bool AppendEntriesAsync(raftRpcProctoc::AppendEntriesArgs *args,
	    std::function<void(
	        bool ok, std::shared_ptr<raftRpcProctoc::AppendEntriesReply>)>
	        cb);
	bool RequestVoteAsync(raftRpcProctoc::AppendEntriesArgs *args,
	    std::function<void(
	        bool ok, std::shared_ptr<raftRpcProctoc::AppendEntriesReply>)>
	        cb);
	bool InstallSnapshotAsync(raftRpcProctoc::AppendEntriesArgs *args,
	    std::function<void(
	        bool ok, std::shared_ptr<raftRpcProctoc::AppendEntriesReply>)>
	        cb);
